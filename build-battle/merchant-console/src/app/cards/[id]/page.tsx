...
// Card status and spend change at runtime through the API; never serve a stale render.
  ...
  return (
    <div className="p-4 sm:p-6">
      ...
      <p className="mt-1 text-sm text-gray-500">
        ...
        <span className="ml-2 font-mono">{card.id}</span>
      </p>
      ...
      <p className="mt-4 text-sm tabular-nums text-gray-900 dark:text-gray-50">
      ...
      <progress
        ...
        className={cx(
          "mt-2 h-2 w-full max-w-md appearance-none overflow-hidden rounded-full",
